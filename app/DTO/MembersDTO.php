...
class MembersDTO
{
    ...
    public function mapData(array $data)
    {
        ...
        $this->children = isset($data['children']) ? json_encode($data['children']) : null;
        ...
        $this->departments = isset($data['departments']) ? json_encode($data['departments']) : null;
        $this->field1 = isset($data['field1']) ? json_encode($data['field1']) : null;
        $this->field2 = $data['field2'] ?? null;
        $this->field3 = isset($data['field3']) ? json_encode($data['field3']) : null;
        $this->field4 = $data['field4'] ?? null;
        $this->field5 = isset($data['field5']) ? json_encode($data['field5']) : null;
        $this->field6 = $data['field6'] ?? null;
        $this->field7 = isset($data['field7']) ? json_encode($data['field7']) : null;
        $this->field8 = $data['field8'] ?? null;
        $this->field9 = isset($data['field9']) ? json_encode($data['field9']) : null;
        $this->field10 = $data['field10'] ?? null;
        $this->field11 = isset($data['field11']) ? json_encode($data['field11']) : null;
